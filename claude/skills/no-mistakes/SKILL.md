...
name: no-mistakes
description: >-
  Validation pipeline before code reaches the push target: automated code review, tests,
  lint, docs, push, PR, CI. Use on /no-mistakes, "run no-mistakes", or a request to gate,
  ship, validate, or safely push changes.
user-invocable: true
---
